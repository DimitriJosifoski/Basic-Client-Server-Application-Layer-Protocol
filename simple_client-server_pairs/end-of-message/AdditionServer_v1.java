...
/**
   This server uses end-of-stream to detect
   the end of the client's request.
<p>
   For each client, this server, <br>
      1) reads a sequence of integer values, one
         value per line of text, up until end-of-stream, <br>
      2) sends back the sum as a text string, <br>
      3) closes the connection to the client.
<p>
...
*/
public class AdditionServer_v1
{
   ...
   public static void main (String[] args)
   {
      ...
      System.out.println("AdditionServer_v1");
