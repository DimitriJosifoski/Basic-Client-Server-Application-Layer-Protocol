...
/**
   This server uses a sentinel value to detect
...
<p>
   For each client, this server, <br>
      1) reads a sequence of positive integer values,
         ...
         up until a negative integer value, <br>
      2) sends back the sum of the positive integers as a text string, <br>
      3) if not end-of-stream, go back to step 1, <br>
...
public class AdditionServer_v3
{
   ...
   public static void main (String[] args)
   {
      ...
      System.out.println("AdditionServer_v3");
      ...
      while (true) // Serve multiple clients.
      {
         ...
         try
         {
            while (in.hasNextInt()) // While not end-of-stream.
            {
               ...
               if (n >= 0) // Did not receive a sentinel value.
               {
