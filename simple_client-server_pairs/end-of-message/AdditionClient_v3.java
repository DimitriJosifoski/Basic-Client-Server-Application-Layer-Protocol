...
/**
   This client uses a sentinel value to signal to
   the server that the client's request is complete.
<p>
   This version of the client, <br>
     1) sends the server a sequence of positive ints, <br>
     2) sends the server a negative int to end the sequence, <br>
...
*/
public class AdditionClient_v3
{
   ...
   public static void main (String[] args)
   {
      ...
      while (stdin.hasNextInt())
      {
         ...
         out.print(n);    // Send a negative sentinel to end the sequence of integers.
         out.print(" ");  // Separate all integers with a space.
         out.flush();
         request += n + " ";
