...
/**
   This client uses a counter to signal to
...
<p>
   This version of the client, <br>
     1) sends the server a positive number indicating
        the length of a sequence of integer values, <br>
     1) sends the server a sequence of ints with the specified length, <br>
...
<p>
   This client will send requests to the server until it reaches
...
public class AdditionClient_v2
{
   ...
   public static void main (String[] args)
   {
      ...
      while ( stdin.hasNextInt() )
      {
         ...
         out.print(length);                  // Send the sequence length to the server.
         out.print(" ");                     // Separate all integers with a space.
         out.flush();
         String request = length + " ";      // Used for logging the request.
