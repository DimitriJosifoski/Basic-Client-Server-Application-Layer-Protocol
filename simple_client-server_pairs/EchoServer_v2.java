...
/**
   This is an echo server that echoes two lines of text.
<p>
   This server expects, and echoes, two lines of input from
   the client and then the client connection is closed by this
   server. The server then waits for another client connection.
<p>
