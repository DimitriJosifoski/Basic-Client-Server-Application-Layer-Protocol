...
/**
   This client sends one fixed line of text to the
   server and then reads the server's response.
<p>
...
public class EchoClient_v1a
{
   ...
   */
   public static void main (String[] args)
   {
      ...
      final String clientMessage = "Please send this back (to pid = " + pid + ")";
