...
/**
   This client implements a purely binary protocol that
   sends an int value to the server and then expects that
   many double values back from the server.
<p>
