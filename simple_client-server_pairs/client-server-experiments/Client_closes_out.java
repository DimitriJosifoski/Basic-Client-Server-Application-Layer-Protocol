...
public class Client_closes_out
{
   ...
   public static void main (String[] args)
   {
      ...
      try
      {
         ...
         System.out.println("CLIENT: Client's socket output stream closed.");
      }
      catch (IOException e)
      {
         System.out.println("CLIENT: Cannot close client's socket output stream.");
         System.out.println( e );
      }
