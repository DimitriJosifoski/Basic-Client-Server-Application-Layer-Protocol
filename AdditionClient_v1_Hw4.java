...
<p>
   This client defaults to server port number 5001.
*/
public class AdditionClient_v1_Hw4
{
   ...
   public static void main (String[] args)
   {
      ...
      System.out.println("AdditionClient_v1_Hw4");
      ...
      int seqLength;  // Should be a non-negative value.
      while ((seqLength = stdin.nextInt()) >= 0)
      {
         // Send the server a request of length seqLength.
         out.print(seqLength);   // Send the sequence length to the server.
      ...
      out.print(seqLength);  // Send a negative sentinel to end the requests.
      out.print(" ");        // Separate all integers with a space.
      out.flush();
